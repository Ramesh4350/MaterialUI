...
export default props => {
  ...
  const numberOfForms = () => {
    if (uncompletedStep > 1) return "Formulaires à completer";
    else if (uncompletedStep === 1) return "Plus qu'un Formulaire";
    else return "Inscription finalisé";
  };
      ...
      >
        ...
        >
          ...
          <Box style={{ display: !uncompletedStep ? "block" : "none" }}>
            ...
            <Typography style={{ color: "white", marginTop: 10 }}>
              Votre dossier à été intégralement complété et est en cours
              d'étude.
              <br />
